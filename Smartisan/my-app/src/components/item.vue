				...
				<div class="item-box">
					<div class="gallery-wrapper">
						<div class="gallery">
							<div class="thumbnail">
								<ul>
									<li :class="[index==listIndex?'on':'']" 
                                    v-for="(item,index) in goodsData[goodIndex].stock_info[colorIndex].imgs" 
                                    :key="index"
							...
							<div class="thumb">
								<ul>
									<li class="on"><img :src="goodsData[goodIndex].stock_info[colorIndex].imgs[listIndex]"></li>
					...
					<div class="banner">
						<div class="sku-custom-title">
							<div class="params-price">
								<span><em>¥</em><i>{{goodsData[goodIndex].stock_info[colorIndex].price}}</i></span>
							</div>
							<div class="params-info">
								<h4>{{goodsData[goodIndex].stock_info[colorIndex].title}}</h4>
								<h6>{{goodsData[goodIndex].stock_info[colorIndex].sub_title}}</h6>
							</div>
						</div>
						<div class="sku-dynamic-params-panel">
							<div class="sku-dynamic-params clear">
								...
								<ul class="params-colors">
									<li :class="[index==colorIndex?'cur':'']" 
                                    v-for="(item,index) in goodsData[goodIndex].stock_info" 
                                    :key="index"
...
import goodsData from '../assets/js/goodsData'
    export default {
       ...
       methods: {
        ...
        beforeMount(){
            this.goodIndex=this.$route.params.goodIndex;
